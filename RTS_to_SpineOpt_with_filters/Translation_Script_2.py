...
"""
try:       
    #sheet_names = pd.ExcelFile(translation_file).sheet_names
    #create_objects("")
    #create_objects("node")
    #create_objects("unit")
    ...
    """
    import_objects(out_db,[('unit','test')])
    print('object imported')
    import_object_parameters(out_db,[('unit','test_param')])
    print('parameter imported')
    import_object_parameter_values(out_db,[('unit','test','test_param',0.0)])
    print('value imported')
    """
